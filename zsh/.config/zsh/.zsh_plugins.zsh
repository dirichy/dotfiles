...
fpath+=( $HOME/Library/Caches/antidote/https-COLON--SLASH--SLASH-github.com-SLASH-qoomon-SLASH-zsh-lazyload )
source $HOME/Library/Caches/antidote/https-COLON--SLASH--SLASH-github.com-SLASH-qoomon-SLASH-zsh-lazyload/zsh-lazyload.plugin.zsh
